...
给**维护**当前主题 skill 的人看。**使用** kami（做文档）-> 读本目录的 `README.md` / `SKILL.md`。
...
当前主题位于 `plugins/kami-themes/skills/republican-manuscript/`。新增主题时，在 `plugins/kami-themes/skills/` 下新建平级目录，并把展示入口补到 `apps/web`。
